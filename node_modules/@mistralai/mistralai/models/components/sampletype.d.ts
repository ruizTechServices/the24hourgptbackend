...
/** @internal */
export declare const SampleType$inboundSchema: z.ZodNativeEnum<typeof SampleType>;
/** @internal */
export declare const SampleType$outboundSchema: z.ZodNativeEnum<typeof SampleType>;
/**
 * @internal
